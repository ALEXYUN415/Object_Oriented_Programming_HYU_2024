...
public class Sorting {
	...
	int cnt_percolateDown=0;
	int cnt_stepInsertionSort=0;
	...
	private void mSort(int p, int r, int[] B) { 
		//추가
		System.out.println("mSort call : cnt_mSort = " + (++cnt_mSort));
		if (p < r) {
			int q = (p+r)/2; 
			mSort(p, q, B);	
			mSort(q+1, r, B);
	...
	private void merge(int p, int q, int r, int[] B) {
		//추가
		System.out.println("merge call : cnt_merge = " + (++cnt_merge));
	...
	private void qSort(int p, int r) {
		//추가
		//System.out.println("qSort call : cnt_qSort = " 
			//	+ (++cnt_qSort));
		
		System.out.println("qSort : p = "+p +"  r ="+ r);
	...
	private int	partition(int p, int r) {
		//추가
		//System.out.println("partition call : cnt_partition = " 
		//				+ (++cnt_partition));	
		int x = A[r];
	...
	private void percolateDown(int i, int n) {
		//추가
		System.out.println("percolateDown call : cnt_percolateDown = " 
						+ (++cnt_percolateDown));	
	...
	void stepInsertionSort(int k, int h) {
		//추가
		System.out.println("stepInsertionSort call : cnt_stepInsertionSort = " 
						+ (++cnt_stepInsertionSort));			
		int j, insItem;
